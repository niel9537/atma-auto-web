...
@section('content')
    ...
    <head>
        ...
        <title>Atma Auto | Add New Pegawai</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">New Pegawai</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{ url('savepegawai') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="card-body">
